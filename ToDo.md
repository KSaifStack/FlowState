<h1>TO-DO</h1>
<div>This log will be updated until FlowState is a completed application with all intended features.</div>
<div>Once you finish a task, cross it out using HTML.</div>
<div>If you have time, look for yourself for known issues with the frontend & backend and add.</div>
